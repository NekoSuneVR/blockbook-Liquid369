...
// magic numbers
const (
	MainnetMagic wire.BitcoinNet = 0x28b4adb8
...
func init() {
	// Deviant mainnet Address encoding magics
	MainNetParams = chaincfg.MainNetParams
	MainNetParams.Net = MainnetMagic
	MainNetParams.PubKeyHashAddrID = []byte{90} // starting with 'D'
	MainNetParams.ScriptHashAddrID = []byte{10}
	MainNetParams.PrivateKeyID = []byte{137}

	// Deviant testnet Address encoding magics
